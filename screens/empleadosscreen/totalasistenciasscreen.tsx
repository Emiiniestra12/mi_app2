...
export const TotalAsistenciaScreen = () => {
  ...
  return (
    <View style={{ flex: 1, paddingHorizontal: 20, paddingTop: 60, backgroundColor: "#1d1420ff", justifyContent:"center"}}>
      ...
      >
        <Text style={temaCarta.buttonText2}>Buscar total de asistencias</Text>
      </TouchableOpacity>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={[temaCarta.cardEstilo, styles.card]}>
            <Text style={{ ...temaCarta.cardText, color: "#d7d41aff" }}>
              TOTAL DE ASISTENCIAS: {item.total_asistencias}
            </Text>
          </View>
        )}
      />
